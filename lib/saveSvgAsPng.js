...
(function () {
  ...
  var inlineImages = async function inlineImages(el, options) {
    var _ref = options || {},
        embedExternalImages = _ref.embedExternalImages;
  ...
  var inlineCss = function inlineCss(el, options) {
    var _ref2 = options || {},
        selectorRemap = _ref2.selectorRemap,
        modifyStyle = _ref2.modifyStyle,
        modifyCss = _ref2.modifyCss,
        fonts = _ref2.fonts,
        excludeUnusedCss = _ref2.excludeUnusedCss;
    ...
    var fontList = fonts || [];
    styleSheetRules().forEach(function (_ref3) {
  ...
  out$.prepareSvg = function (el, options, done) {
    ...
    var _ref4 = options || {},
        ...
        _ref4$excludeCss = _ref4.excludeCss,
        excludeCss = _ref4$excludeCss === undefined ? false : _ref4$excludeCss;

    return inlineImages(el, options).then(function () {
